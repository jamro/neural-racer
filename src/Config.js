class Config {
  constructor() {
    ...
    this.replayInterval = 13; // every how many epochs to run evolution on random, completed track
  ...
  setStandardMode() {
    ...
    this.evolve.eliminationRate = 0.04; // percentage of weakest genomes to eliminate every `eliminationEpochs` epochs 
    ...
    this.evolve.crossover.blendRatio = 0.6; // percentage blend crossovers, the remaining percentage is uniform crossover
    ...
    this.evolve.mutation.outputSigma = 0.14; // standard deviation of the mutation (applied to output layer of NN)
  }
